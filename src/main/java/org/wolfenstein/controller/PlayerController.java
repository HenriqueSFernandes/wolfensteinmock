...
public class PlayerController extends GameController {
    ...
    public void moveForward() {
        movePlayer(getModel().getPlayer().getPosition().moveForward());
    }

    public void rotateClockwise() {
        movePlayer(getModel().getPlayer().getPosition().rotateClockwise());
    }

    public void rotateAntiClockwise() {
        movePlayer(getModel().getPlayer().getPosition().rotateAntiClockwise());
    }

    public void moveBackward() {
        movePlayer(getModel().getPlayer().getPosition().moveBackwards());
    }
